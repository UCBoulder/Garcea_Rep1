...
Overlay_PCC_ch2 = labeloverlay(ch2_adjG, PCC_mask,'Transparency',0.8,'Colormap','summer'); % 0.1 opaque; 0.7default
Overlay_PCC_ch3 = labeloverlay(ch3_adjG, PCC_mask,'Transparency',0.9,'Colormap','autumn'); % 0.1 opaque; 0.7default
